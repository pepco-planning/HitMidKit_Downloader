...
########################
    ...
    if PARAMETERS['Hierarchy'][2] == '2':
        cols = hardline_cols
        kpi1_cols = ['SKU Class', 'ROS_V_Tier1', 'ROS_V_Tier2', 'ROS_V_Tier3', 'ROS_M_Tier1',
                     'ROS_M_Tier2', 'ROS_M_Tier3', 'ROS_V_Tier1 MAN', 'ROS_V_Tier2 MAN',
                     'ROS_V_Tier3 MAN', 'ROS_M_Tier1 MAN', 'ROS_M_Tier2 MAN',
                     'ROS_M_Tier3 MAN']
        kpi2_cols = ['MerchGroup', 'ST Tier 1', 'ST Tier 2', 'ST Tier 1 MAN',
                     'ST Tier 2 MAN']
    else:
        cols = clothing_cols
        kpi1_cols = ['SKU Class', 'ROS_V_Tier1', 'ROS_V_Tier2', 'ROS_V_Tier1 MAN', 'ROS_V_Tier2 MAN']
        kpi2_cols = ['MerchGroup', 'ST Tier 1', 'ST Tier 2', 'MD Tier 1',
                     'MD Tier 2', 'ST Tier 1 MAN', 'ST Tier 2 MAN', 'MD Tier 1 MAN',
                     'MD Tier 2 MAN']

    # Check if no data. If so, then close the program
    if df_final.shape[0] == 0:
        func.showStatusModel(MODEL_PATH, 1, PARAMETERS['Departament'], PARAMETERS['Hierarchy'],
                             'No required data', 8, STATUS_TOTAL_NO)
        ...
        func.showStatusModel(MODEL_PATH, 0, dep=None, hier=None, status=None, value=STATUS_TOTAL_NO,
                             value_total=STATUS_TOTAL_NO)
        sys.exit()
    else:
        pass
