...
def calculateSummary():
    ...
    func.showStatusModel(PARAMETERS['Path'], 1, PARAMETERS['Departament'], PARAMETERS['Hierarchy'], 'Downloading Inventory...',1,STATUS_TOTAL_NO)
    df_Inventory = pd.read_csv(PARAMETERS['Path Inventory'] + "\\" + f"{PARAMETERS['Hierarchy']}_HitMidKit.csv")

    ############################################################################################
    # variable for DAX
    func.showStatusModel(PARAMETERS['Path'], 1, PARAMETERS['Departament'], PARAMETERS['Hierarchy'], 'Downloading Reports...',2,STATUS_TOTAL_NO)
    ...
    func.showStatusModel(PARAMETERS['Path'], 1, PARAMETERS['Departament'], PARAMETERS['Hierarchy'],
...
########################
    ...
    df_final.to_excel(f"Summary_{PARAMETERS['Hierarchy']}.xlsx",index=False)
    func.showStatusModel(PARAMETERS['Path'], 0, dep=None, hier=None, status=None,value=STATUS_TOTAL_NO,value_total=STATUS_TOTAL_NO)
